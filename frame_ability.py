...
class abframe:
    def __init__(self, character, parent):
        ...
        self.StrLabel = Label(self.frame, text="STR:", font=("EB Garamond", 18), bd=2)
        self.DexLabel = Label(self.frame, text="DEX:", font=("EB Garamond", 18), bd=2)
        self.ConLabel = Label(self.frame, text="CON:", font=("EB Garamond", 18), bd=2)
        self.IntLabel = Label(self.frame, text="INT:", font=("EB Garamond", 18), bd=2)
        self.WisLabel = Label(self.frame, text="WIS:", font=("EB Garamond", 18), bd=2)
        self.ChaLabel = Label(self.frame, text="CHA:", font=("EB Garamond", 18), bd=2)
        ...
        self.StrModLabel = Label(self.frame, text=str(abm(self.array["str"])), font=("EB Garamond", 24), bd=2)
        self.DexModLabel = Label(self.frame, text=str(abm(self.array["dex"])), font=("EB Garamond", 24), bd=2)
        self.ConModLabel = Label(self.frame, text=str(abm(self.array["con"])), font=("EB Garamond", 24), bd=2)
        self.IntModLabel = Label(self.frame, text=str(abm(self.array["int"])), font=("EB Garamond", 24), bd=2)
        self.WisModLabel = Label(self.frame, text=str(abm(self.array["wis"])), font=("EB Garamond", 24), bd=2)
        self.ChaModLabel = Label(self.frame, text=str(abm(self.array["cha"])), font=("EB Garamond", 24), bd=2)
        ...
        self.StrStatLabel = Label(self.frame, text=f'({str(self.array["str"])})', font=("EB Garamond", 12), bd=2)
        self.DexStatLabel = Label(self.frame, text=f'({str(self.array["dex"])})', font=("EB Garamond", 12), bd=2)
        self.ConStatLabel = Label(self.frame, text=f'({str(self.array["con"])})', font=("EB Garamond", 12), bd=2)
        self.IntStatLabel = Label(self.frame, text=f'({str(self.array["int"])})', font=("EB Garamond", 12), bd=2)
        self.WisStatLabel = Label(self.frame, text=f'({str(self.array["wis"])})', font=("EB Garamond", 12), bd=2)
        self.ChaStatLabel = Label(self.frame, text=f'({str(self.array["cha"])})', font=("EB Garamond", 12), bd=2)
